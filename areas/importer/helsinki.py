    ...
    def _process_contract_zones(self, data_source):
        ...
        for feat in layer:
            data = {
                ...
                "contact_person": str(feat["talkoot"]),
                "email": str(feat["talkoot_email"]),
                "phone": str(feat["talkoot_puh"]),
                "secondary_contact_person": str(feat["talkoot_varahlo"]),
                "secondary_email": str(feat["talkoot_varahlo_email"]),
                "secondary_phone": str(feat["talkoot_varahlo_puh"]),
